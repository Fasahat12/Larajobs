...
<html lang="en">
    ...
    <body class="mb-48">
        <nav class="flex justify-between items-center mb-4">
            <a href="/" class="pl-4 text-7xl font-bold text-gray-800 hover:text-gray-600">
                {{-- <img class="w-24" src='{{asset("images/logo.png")}}' alt="" class="logo"/> --}}
                L<span class='text-red-500'>J</span>
            </a>
    ...
    >
    <p class="ml-2 md:text-base text-xs">Copyright &copy; 2023, All Rights reserved</p>

    <a
        href="/listings/create"
        class="ml-2 absolute top-1/4 right-10 bg-black text-white py-2 px-5 md:text-base text-sm"
        >Post Job</a>
</footer>
